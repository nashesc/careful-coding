...
Real-world code examples demonstrating the four principles. Each example shows what LLMs commonly do wrong and how to fix it. Read this file when you want a fuller before/after walkthrough than the condensed version in SKILL.md - e.g. when explaining *why* an approach is wrong, not just flagging that it is.
